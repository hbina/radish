...
func TestStringifyGoodRespString(t *testing.T) {
	res, ok := StringifyRespBytes([]byte("+OK\r\n"))
...
func TestStringifyGoodRespError(t *testing.T) {
	res, ok := StringifyRespBytes([]byte("-Error message\r\n"))
	assert.Equal(t, "Error message", res)
	assert.True(t, ok)
}

func TestStringifyBadRespError(t *testing.T) {
	res, ok := StringifyRespBytes([]byte("-Error message\r"))
	assert.Empty(t, res)
	assert.False(t, ok)
}
...
func TestStringifyGoodRespInteger(t *testing.T) {
	// Integers
	res, ok := StringifyRespBytes([]byte(":1\r\n"))
	assert.Equal(t, "(integer) 1", res)
	assert.True(t, ok)
	res, ok = StringifyRespBytes([]byte(":-100\r\n"))
	assert.Equal(t, "(integer) -100", res)
	assert.True(t, ok)
	res, ok = StringifyRespBytes([]byte(":32\r\n"))
	assert.Equal(t, "(integer) 32", res)
	assert.True(t, ok)
	res, ok = StringifyRespBytes([]byte(":-0\r\n"))
...
func TestStringifyBadRespInteger(t *testing.T) {
	// Integers
	res, ok := StringifyRespBytes([]byte(":1ddd\r\n"))
	assert.Empty(t, res)
	assert.False(t, ok)

	res, ok = StringifyRespBytes([]byte(":-1d00\r\n"))
	assert.Empty(t, res)
	assert.False(t, ok)

	res, ok = StringifyRespBytes([]byte(":v32\r\n"))
	assert.Empty(t, res)
	assert.False(t, ok)

	res, ok = StringifyRespBytes([]byte(":-v0\r\n"))
	assert.Empty(t, res)
	assert.False(t, ok)
}

func TestStringifyRespGoodBulkString(t *testing.T) {
	res, ok := StringifyRespBytes([]byte("$5\r\nhello\r\n"))
...
func TestStringifyRespBadBulkString(t *testing.T) {
	...
	res, ok = StringifyRespBytes([]byte("$2\r\nddd\r\n"))
	assert.Empty(t, res)
	assert.False(t, ok)
}
...
func TestStringifyGoodRespArray(t *testing.T) {
	...
	res, ok = StringifyRespBytes([]byte("*3\r\n+a\r\n*2\r\n*2\r\n+b\r\n+c\r\n+d\r\n+e\r\n"))
	assert.Equal(t, "1) \"a\"\n2) 1) 1) \"b\"\n      2) \"c\"\n   2) \"d\"\n3) \"e\"", res)
	assert.True(t, ok)

	res, ok = StringifyRespBytes([]byte("*4\r\n$7\r\nmatches\r\n*4\r\n*2\r\n*2\r\n:3\r\n:4\r\n*2\r\n:12\r\n:13\r\n*2\r\n*2\r\n:2\r\n:2\r\n*2\r\n:8\r\n:8\r\n*2\r\n*2\r\n:1\r\n:1\r\n*2\r\n:4\r\n:4\r\n*2\r\n*2\r\n:0\r\n:0\r\n*2\r\n:0\r\n:0\r\n$3\r\nlen\r\n:5\r\n"))
